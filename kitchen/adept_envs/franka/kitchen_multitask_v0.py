...
import os
import numpy as np
from kitchen.adept_envs import robot_env
...
class KitchenV0(robot_env.RobotEnv):
    ...
    ROBOTS = {'robot': 'kitchen.adept_envs.franka.robot.franka_robot:Robot_VelAct'}
    MODEl = os.path.join(
...
class KitchenTaskRelaxV1(KitchenV0):
    ...
    def render(self, mode='human'):
        if mode =='rgb_array':
            ...
            camera = engine.MovableCamera(self.sim, 320, 480)
