...
class BaseAlgorithm(ABC):
    ...
    def _setup_learn(
        ...
        if reset_num_timesteps or self._last_obs is None:
            ...
            self._last_info = {'goal': 'There is a red sphere; are there any green rubber balls on the right side of it?'}
    ...
    def lang_load(
        ...
        **kwargs,
        ...
        if "policy_kwargs" in kwargs and kwargs["policy_kwargs"] != data["policy_kwargs"]:
            ...
            print(colored('=', 'red') * 32 + f' {colored("Warning", "red")} ' + colored('=', 'red') * 32)
            print(f"The specified policy kwargs do not equal the stored policy kwargs.")
            print(f"Stored kwargs: {data['policy_kwargs']}, specified kwargs: {kwargs['policy_kwargs']}")
